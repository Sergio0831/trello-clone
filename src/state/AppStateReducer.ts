...
export const appStateReducer = (
	...
	switch (action.type) {
		...
		case 'MOVE_TASK': {
			const { draggedItemId, hoveredItemId, sourceColumn, targetColumn } =
				action.payload;

			const sourceListIndex = findItemIndexById(draft.lists, sourceColumn);
			const targetListIndex = findItemIndexById(draft.lists, targetColumn);
